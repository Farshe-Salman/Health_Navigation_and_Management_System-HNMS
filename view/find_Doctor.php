  ...
  <div id="doctors" class="section">
    ...
    <div class="doctor-list" id="doctorList">
        ...
        <div class="doctor-card">
            <img src="../assets/uploads/doctors_document/<?= $doctor['profile_image'] ?: '' ?>" alt="<?= $doctor['doctor_name'] ?>">
            ...
            <div class="button-group">
                <button class="btn-primary" onclick="alert('Book appointment with <?= $doctor['doctor_name'] ?>')">Request Appointment</button>
...
<div id="doctorModal" class="modal">
    <div class="modal-content">
        <img id="modalDoctorImage" src="../assets/uploads/" alt="Doctor Image">
